...
def load_compress_model(model_path, device, torch_dtype, use_fast, revision="main",load_in_4bit=False):
    ...
    with init_empty_weights():
        ...
        try:
            ...
            if "T5Config" in str(type(config)):
                ...
                print("fastchat/model/compression.py")
                print("load_compress_modell")
                print("Due to 4bit")
