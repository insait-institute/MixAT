...
if __name__ == "__main__":
    ...
    parser.add_argument("--judge-model", type=str, default="gpt-4o") #Changed the judge model to gpt-4o from gpt-4 at 12. 08. 2024. 11:56
    ...
    if args.mode == "single":
        ...
        output_file = (
            f"data/{args.bench_name}/model_judgment/{args.judge_model}_single2_{models}.jsonl"
        )
